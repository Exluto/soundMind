...
class GameScene: SKScene, SKPhysicsContactDelegate {
  ...
  override func didMove(to view: SKView) {
    ...
    playerAnimationJump = setupAnimationWithPrefix("player01_jump_", start: 1, end: 25, timePerFrame: 0.1)
    playerAnimationFall = setupAnimationWithPrefix("player01_jump_", start: 1, end: 25, timePerFrame: 0.1)
